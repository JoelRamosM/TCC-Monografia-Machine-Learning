...
\autor{Joel Ramos Michaliszen Junior}
\titulo{Machine Learning: quais categorias e como utilizá-las}
\data{2016}
\local{Fortaleza -- Ceará}

% Exemplo: \dataaprovacao{01 de Janeiro de 2012}
\dataaprovacao{01 de Dezembro de 2016}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%     Informação sobre o Orientador       %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\orientador{Prof. Mestre João Carlos de Sousa do Vale}
...
\membrodabancadois{Profa. Mestre Valneide Cabral}
\membrodabancatres{Prof. Mestre Adail Silva Nunes }
