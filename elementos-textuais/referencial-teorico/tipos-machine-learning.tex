...
utiliza tanto atributos discretos quanto recursivos para classificar. Alguns algoritimos como ID3, ASSISTANT, CART E C4.5 são utilizados para construção destas árvores.

Os algoritmos de construçao de árvores de decisão tomam como base  os critérios de dividir para conquistar para construir a árvore e o critério guloso para escolha dos melhores atributos e partições.    
