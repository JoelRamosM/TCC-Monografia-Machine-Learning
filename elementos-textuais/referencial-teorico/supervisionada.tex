...
Um classificador é gerado após exemplos rotulados serem submetidos à um dado indutor, após a geração do classificador 
...
A ~\autoref{fig:amostra-transacoes} ilustra o exemplo de transações de cartão de crédito fraudulentas onde cada ponto no plano representa uma transação,
dado que tem-se uma amostra de transações realizadas. Após estes dados serem submetidos ao classificador, irá predizer com um certo grau de probabilidade 
a qual classe o exemplo pertence, estas classes são legítima e fraudulenta, logo sua saída basicamente será como aprensentado na ~\autoref{fig:amostra-transacoes-classefied}:
\begin{figure}[ht!]
	\centering
...
\begin{table}[h!]
	\Caption{\label{tab:dados-imoveis} Exemplos rotulado de dados de imóveis}
	\IBGEtab{}{
		\begin{tabular}{rr}
			\toprule
			Área ($m^{2}$) & Preco (R\$) "Rótulo"\\
			\midrule \midrule
			192,00  &        250.000,00  \\
			140,55  &        187.000,00  \\
			88,90   &         88.590,00  \\
